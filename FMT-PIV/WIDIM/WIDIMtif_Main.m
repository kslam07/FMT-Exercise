...
foldread='../data/Alpha0_dt100/';        % (*** fill in ***) folder containing the images
...
iterNum=1;                          % number of iterations (integer >=1) for the multi-pass processing
...
M = 0.0478;                         % Magnification factor
xo = 137;                           % x origin in pixels
yo = 532;                           % y origin in pixels
MaskFile = 'Mask_Alpha_0';     % matlab file containing the mask at that angle of attack
